...
mex <- air[air$country == "Mexico", ]
jpn <- air[air$country == "Japan", ]

plot(outside ~ year, data=mex, ylim=c(0, 120), type="l", col="black", ylab="Death rate", lwd=1) 
#las=1, lwd=3 is for where to place the axis and to identify line width
#or 
# plot(per$year, per$outside, ylim=c(0, 120), type="l", col="black", ylab="Death rate", las=1, lwd=3)

lines(inside ~ year, data=mex, lty=2, col="gray", lwd=3) #lty is line type
lines(outside ~ year, data=jpn, lty=3, col="red", lwd=3)
lines(inside ~ year, data=jpn, lty=4, col="blue", lwd=3)
legend("topright", c("Mexico, outside", "Mexico, inside", "Japan, outside", "Japan, inside"), 
